const buttons = ["NES", "SNES", "N64", "GameBoy", "Genesis", "PS1", "PS2", "PS3",
    "PS4", "GBA", "Xbox", "360", "Wii", "WiiU", "DS", "3DS", "Vita", "GameCube", "Dreamcast", "XBOne"];
...
for (let i = 0; i < buttons.length; i++) {
    ...
    $('#' + buttons[i]).click(function () {
        console.log(buttons);
        console.log(buttons[i]);
        $('#' + buttons[i]).toggleClass('highlight');
        $('.' + buttons[i]).toggleClass('get-out');
